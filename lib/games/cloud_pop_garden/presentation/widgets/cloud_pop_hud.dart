...
class CloudPopHud extends StatelessWidget {
  const CloudPopHud({
    super.key,
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          const Spacer(),
          _Pill(icon: Icons.water_drop_rounded, label: '$flowersWatered'),
          const SizedBox(width: AppSpacing.sm),
          _Pill(icon: Icons.monetization_on_rounded, label: '+$coinsEarned', highlight: true),
          const SizedBox(width: AppSpacing.sm),
          _Pill(icon: Icons.star_rounded, label: '+$starsEarned'),
          const SizedBox(width: AppSpacing.sm),
          IconButton(
        ...
        children: [
          ...
          Text(
            ...
            style: context.textTheme.titleSmall?.copyWith(
              ...
              color: highlight ? AppColors.orange : color,
            ),
          ),
        ],
      ),
