...
class BalloonParadeHud extends StatelessWidget {
  const BalloonParadeHud({
    super.key,
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          const Spacer(),
          _Pill(icon: Icons.celebration_rounded, label: '$balloonsPopped'),
          ...
          Material(
            ...
            child: InkWell(
              ...
              child: const Padding(
                ...
                child: Icon(Icons.pause_rounded, size: 28, color: AppColors.skyBlueDark),
              ),
            ),
          ),
        ],
