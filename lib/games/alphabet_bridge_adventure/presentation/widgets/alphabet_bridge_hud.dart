...
class AlphabetBridgeHud extends StatelessWidget {
  const AlphabetBridgeHud({
    super.key,
      ...
      child: Row(
        ...
        children: [
          Icon(
            icon,
            size: large ? 22 : 18,
            color: gold ? AppColors.sunYellow : const Color(0xFF5E35B1),
          ),
...
class AlphabetBridgeVictoryOverlay extends StatelessWidget {
  const AlphabetBridgeVictoryOverlay({
    super.key,
  ...
  final AlphabetBridgeResult result;
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      color: const Color(0xFF7E57C2).withValues(alpha: 0.92),
      child: SafeArea(
        child: Center(
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                _Row('🔤 Letters Matched', '${result.correctMatches}'),
