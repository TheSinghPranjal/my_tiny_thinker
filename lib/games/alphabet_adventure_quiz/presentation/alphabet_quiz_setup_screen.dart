          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                Text(
                  'Find the picture that matches the letter!',
                  textAlign: TextAlign.center,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Wrap(
                        ...
                        children: kAlphabetSkills
                            .map(
                              (s) => Chip(
                                label: Text(s),
                                backgroundColor:
                                    AppColors.sunYellow.withValues(alpha: 0.35),
                              ),
                            )
                            .toList(),
                      ),
                ...
                TTButton(
                  ...
                  onPressed: () => context.push(AppRoutes.alphabetQuizGame),
                ),
                const SizedBox(height: AppSpacing.lg),
              ],
            ),
