...
class MonkeyHud extends StatelessWidget {
  const MonkeyHud({
    super.key,
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          Icon(icon, color: const Color(0xFF558B2F), size: 22),
...
class MonkeyVictoryOverlay extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      color: const Color(0xFF33691E).withValues(alpha: 0.88),
      child: SafeArea(
        child: Center(
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                _Row('🍌 Bananas Fed', '${result.bananasFed}'),
                _Row('🍎 Apples Tapped', '${result.applesTapped}'),
