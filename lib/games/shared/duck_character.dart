...
/// Chubby yellow duck with a tuft, drawn from plain state so it can be
/// reused wherever a duck character is needed. Currently used by Hungry
/// Duck Pond Adventure.
class DuckCharacter extends StatelessWidget {
  const DuckCharacter({
    super.key,
...
class DuckPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final flap = math.sin(wingFlap) * (chasing ? 0.55 : celebrating ? 0.4 : 0.22);
