                  ...
                  children: [
                    GameSessionHud(
                      remainingSeconds: ref.watch(
                        oceanFishControllerProvider.select((s) => s.remainingSeconds),
                      ),
                      coinsEarned: ref.watch(
                        oceanFishControllerProvider.select((s) => s.coinsEarned),
                      ),
                      starsEarned: ref.watch(
                        oceanFishControllerProvider.select((s) => s.starsEarned),
                      ),
