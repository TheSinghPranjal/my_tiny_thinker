...
class CompleteWordSetupScreen extends ConsumerWidget {
  const CompleteWordSetupScreen({super.key});
    ...
    return CompleteWordAdventureBackground(
      child: Scaffold(
        ...
        body: GameSetupScaffold(
          emoji: '✏️📚',
          emojiSize: 80,
          title: 'Complete the Word Adventure',
          subtitle:
              'Tap letters to spell the word!\n'
              '${settings.wordLength.label} · keep going until time is up',
          skills: kCompleteWordSkills,
          ...
          playLabel: 'Play!',
          onPlay: () => context.push(AppRoutes.completeTheWordGame),
        ),
      ),
    );
  }
