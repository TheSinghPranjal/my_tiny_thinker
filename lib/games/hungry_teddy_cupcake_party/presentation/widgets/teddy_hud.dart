...
class TeddyHud extends StatelessWidget {
  const TeddyHud({
    super.key,
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          const Spacer(),
          _Pill(Icons.cake_rounded, '$cupcakesFed', AppColors.white, fontScale),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          Icon(icon, color: const Color(0xFFAB47BC), size: 22),
...
class TeddyVictoryOverlay extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      color: const Color(0xFFAB47BC).withValues(alpha: 0.88),
      child: SafeArea(
        child: Center(
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                _Row('🧁 Cupcakes Fed', '${result.cupcakesFed}'),
                _Row('✨ Golden Cupcakes', '${result.goldenFed}'),
                _Row('🍰 Favorite Flavor', result.favoriteFlavor),
      ...
      child: Row(
        ...
        children: [
          Flexible(
            child: Text(
              label,
              style: context.textTheme.titleMedium?.copyWith(color: AppColors.white.withValues(alpha: 0.95)),
            ),
          ),
          Text(
            value,
            style: context.textTheme.titleMedium?.copyWith(color: AppColors.white, fontWeight: FontWeight.w800),
          ),
        ],
      ),
    );
