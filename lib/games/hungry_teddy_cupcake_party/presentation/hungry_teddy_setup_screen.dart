              ...
              children: [
                ...
                Text(
                  ...
                  style: context.textTheme.displaySmall?.copyWith(
                    ...
                    shadows: const [Shadow(color: Color(0xFFAB47BC), blurRadius: 6)],
                  ),
                ),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Wrap(
                        ...
                        children: kHungryTeddySkills
                            .map((s) => Chip(
                                  label: Text(s),
                                  backgroundColor:
                                      const Color(0xFFF48FB1).withValues(alpha: 0.35),
                                ))
                            .toList(),
                      ),
                    ],
                ...
                TTButton(
                  ...
                  onPressed: () => context.push(AppRoutes.hungryTeddyGame),
                ),
                const SizedBox(height: AppSpacing.lg),
              ],
            ),
